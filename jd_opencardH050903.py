...
"""
File: jd_opencardH050903.py(5.9-5.21 爱让好物 成为礼物3)
Author: HarbourJ
Date: 2023/3/15 10:00
TG: https://t.me/HarbourToulu
cron: 0 0 */3 8-21 5 *
new Env('5.9-5.21 爱让好物 成为礼物3');
ActivityEntry: https://lzdz1-isv.isvjcloud.com/m/1000006644/8950936/dz288f6a084de7ba829963a36bc4ff/
...
venderId = "1000006644"
activityId = "dz288f6a084de7ba829963a36bc4ff"
activity_url = f"https://lzdz1-isv.isvjcloud.com/m/1000006644/8487146/{activityId}/?shareUuid={inviterUuid}&adsource=null"
print(f"【🛳活动入口】https://lzdz1-isv.isvjcloud.com/m/1000006644/8487146/{activityId}")
...
if __name__ == '__main__':
    ...
    if len(cks) == 1:
        ...
        activityUrl = f"https://lzdz1-isv.isvjcloud.com/m/1000006644/7722148/{activityId}/?shareUuid={shareUuid}&adsource=null"
    num = 0
    for cookie in cks[:]:
        num += 1
        if num == 1:
        ...
        if num == 1:
            ...
            shareUuid = actorUuid
            activityUrl = f"https://lzdz1-isv.isvjcloud.com/m/1000006644/8487146/{activityId}/?shareUuid={shareUuid}&adsource=null"
