...
!(async () => {
    ...
    $.activityId = '90322060107'

    let authorCodeList = [
        'd45d8d4c404a4df699196a48fed41bb5',
        '3bbdbf55b9144185ac87230f62fafa8c',
        'abab365a75e74548adbda4b53df30312',
    ];
...
async function run() {
    try {
        ...
        await $.wait(1500);
        $.openList = [21304,139403,184189,694930,725113,759089,10080546,10517358,10537865,10622393,10924630,12150263];
