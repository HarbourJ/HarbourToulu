...
All变量适用
————————————————
入口：[ 5.15~5.28 童装童鞋盛典 (https://lzdz1-isv.isvjcloud.com/dingzhi/may/childrenWear/activity?activityId=dz46b2dbbde1914438a47a994cc11c&shareUuid=ad2522798ee7449bb4a97e72cc1463f4)]
...
!(async () => {
  ...
  $.shareUuid = "b66891498d3a45a7bc33a4d405dbab94"
  console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/may/childrenWear/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
  let shareUuidArr = [$.shareUuid,"b66891498d3a45a7bc33a4d405dbab94","6075bb44c0f24142993e4b048fd414ab"]
  ...
  switch (type) {
    case 'isvObfuscator':
      ...
      case 'accessLogWithAD':
        ...
        let pageurl = `${domain}/dingzhi/may/childrenWear/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`
