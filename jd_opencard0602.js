...
All变量适用
————————————————
入口：[ 6.1~6.20 大牌狂欢嗨享购 (https://lzdz1-isv.isvjcloud.com/dingzhi/may/brandUnion/activity?activityId=dz46b2dbbde1914438a47a994cc11c&shareUuid=ad2522798ee7449bb4a97e72cc1463f4)]
...
const $ = new Env('6.1~6.20 大牌狂欢嗨享购');
...
!(async () => {
  ...
  $.shareUuid = "528c22771b884b888c8f4e0ba6d55493"
  console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/may/brandUnion/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
  let shareUuidArr = [$.shareUuid,"528c22771b884b888c8f4e0ba6d55493","55527434218c44038d5f1efe6f859852"]
  ...
  switch (type) {
    case 'isvObfuscator':
      ...
      case 'accessLogWithAD':
        ...
        let pageurl = `${domain}/dingzhi/may/brandUnion/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`
      ...
      case 'activityContent':
        url = `${domain}/dingzhi/may/brandUnion/activityContent`;
      ...
      case 'getShareRecord':
        ...
        break;
      case '抽奖':
        url = `${domain}/dingzhi/may/brandUnion/draw`;
...
function getPostRequest(url, body, method="POST") {
  ...
  if(url.indexOf('https://lzdz1-isv.isvjcloud.com') > -1){
    headers["Referer"] = `https://lzdz1-isv.isvjcloud.com/dingzhi/may/brandUnion/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`
...
function getCk() {
  return new Promise(resolve => {
    let get = {
      url:`https://lzdz1-isv.isvjcloud.com/dingzhi/may/brandUnion/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
