...
"""
File: jd_opencardH051501.py(5.15-5.21 爱让好物 成为礼物4)
Author: HarbourJ
...
venderId = "1000003221"
activityId = "dz7d03871942fc8f0dd9382d76af63"
activity_url = f"https://lzdz1-isv.isvjcloud.com/m/1000003221/8487146/{activityId}/?shareUuid={inviterUuid}&adsource=null"
print(f"【🛳活动入口】https://lzdz1-isv.isvjcloud.com/m/1000003221/8487146/{activityId}")
...
if __name__ == '__main__':
    ...
    if len(cks) == 1:
        ...
        activityUrl = f"https://lzdz1-isv.isvjcloud.com/m/1000003221/7722148/{activityId}/?shareUuid={shareUuid}&adsource=null"
    num = 0
    for cookie in cks[:]:
        num += 1
        if num == 1:
        ...
        if num == 1:
            ...
            shareUuid = actorUuid
            activityUrl = f"https://lzdz1-isv.isvjcloud.com/m/1000003221/8487146/{activityId}/?shareUuid={shareUuid}&adsource=null"
