...
const $ = new Env('6.1~6.18 618感恩有你 真情回馈 ')
...
!(async () => {
    ...
    $.activityId = '90322060101'

    let authorCodeList = [
        'abdd7075ed1647da9bc14f99a1dd6ec2',
        'fc3d2c5f3b574c1a988d6f91e8753daf',
    ];
...
async function run() {
    try {
        ...
        await $.wait(1500);
        $.openList = [1000004065,1000164941,1000001195,10509329,1000003706,1000000866,1000099701,1000090242,1000384306,1000090821,1000393207];
