...
"""
File: jd_inviteDrawPrize_JD.py(转赚邀好友抽现金抽奖JD)
Author: HarbourJ
Date: 2023/3/15 10:00
TG: https://t.me/HarbourToulu
cron: 30 0 1,21 * * *
new Env('转赚邀好友抽现金抽奖JD');
...
linkIds =['3orGfh1YkwNLksxOcN8zWQ']#line:23
...
def get_h5st_body (O00O00O0OO00OO0O0 ,OOOOOO0OOOOOOO0O0 ,O0O00OO0OOOOO0OOO ,O0O0OO00O0O0O00OO ,O0O00O0O0O00OO000 ):#line:60
    ...
    try :#line:69
        OOO0OOOO000O0O00O = ["aHR0cDovLzEuMTQuMjA4LjE3ODozMDAyL2FwaS9oNXN0","aHR0cDovLzE0MS4xNDQuMjI1LjI1MDozMDAyL2FwaS9oNXN0","aHR0cDovLzEuOTQuOC4yNDQ6MzAwMi9hcGkvaDVzdA=="]#line:71
    ...
    for index ,linkId in enumerate (linkIds ,1 ):#line:243
        ...
        while True :#line:245
            ...
            for item in items :#line:258
                ...
                if prizeType ==4 and state !=3 and state !=4 :#line:268
                    cashInfo =apCashWithDraw (cookie ,id ,poolBaseId ,prizeGroupId ,prizeBaseId )#line:269
