...
"""
File: jd_opencardH050902.py(5.9-5.21 爱让好物 成为礼物2)
Author: HarbourJ
Date: 2023/3/15 10:00
TG: https://t.me/HarbourToulu
cron: 0 0 */3 8-21 5 *
new Env('5.9-5.21 爱让好物 成为礼物2');
ActivityEntry: https://lzdz1-isv.isvjcloud.com/m/1000376290/8950936/dzdc0e8a1e42fc877dfb4de8961650/
Description: 开卡30 邀请20
            并发变量: export jd_opencardH0509_uuid="你的助力码"
"""
...
venderId = "1000376290"
activityId = "dzdc0e8a1e42fc877dfb4de8961650"
activity_url = f"https://lzdz1-isv.isvjcloud.com/m/1000376290/8487146/{activityId}/?shareUuid={inviterUuid}&adsource=null"
print(f"【🛳活动入口】https://lzdz1-isv.isvjcloud.com/m/1000376290/8487146/{activityId}")
...
def activityContent(pin, pinImg, nickname):
    url = "https://lzdz1-isv.isvjcloud.com/dingzhi/apr/union/activityContent"
    try:
...
def initOpenCard(pin, actorUuid, shareUuid):
    url = "https://lzdz1-isv.isvjcloud.com/dingzhi/apr/union/initOpenCard"
...
def saveTask(actorUuid, shareUuid, pin, taskType, taskValue):
    url = "https://lzdz1-isv.isvjcloud.com/dingzhi/apr/union/saveTask"
...
if __name__ == '__main__':
    ...
    if len(cks) == 1:
        ...
        activityUrl = f"https://lzdz1-isv.isvjcloud.com/m/1000376290/7722148/{activityId}/?shareUuid={shareUuid}&adsource=null"
    num = 0
    for cookie in cks[:]:
        num += 1
        if num == 1:
        ...
        try:
            ...
            if getPin is not None:
                ...
                if allOpenCard:
                    ...
                    print(f"现在去开卡,共计{len(unOpenCardLists)}张卡")
                    for shop in unOpenCardLists:
                        ...
                        if open_result is not None:
                            ...
                            if "加入店铺会员成功" in open_result[0]:
                                ...
                                initOC = initOpenCard(pin, actorUuid, shareUuid)
                                if "openCardBeans" in initOC:
                                    if int(initOC["openCardBeans"]) > 0:
                                        print(f"🎁开卡{venderCardName}获得{initOC['openCardBeans']}豆")
                        time.sleep(1.5)
        ...
        if num == 1:
            ...
            shareUuid = actorUuid
            activityUrl = f"https://lzdz1-isv.isvjcloud.com/m/1000376290/8487146/{activityId}/?shareUuid={shareUuid}&adsource=null"
