...
"""
File: jd_opencardH082201.py(8.13-8.22 爱让好物 成为礼物1)
Author: HarbourJ
Date: 2023/8/22 10:00
TG: https://t.me/HarbourToulu
cron: 0 0 */3 13-22 8 *
new Env('8.13-8.22 爱让好物 成为礼物1');
ActivityEntry: https://lzdz1-isv.isvjcloud.com/m/1000007395/dz492539a34bee9cd44e0cd006855e
Description: 开卡30 邀请20
            并发变量: export jd_opencardH082201_uuid="你的助力码"
"""
...
activity_url = f"https://lzdz1-isv.isvjcloud.com/m/1000007395/8487146/{activityId}/?shareUuid={inviterUuid}&adsource=null"
print(f"【🛳活动入口】https://lzdz1-isv.isvjcloud.com/m/1000007395/8487146/{activityId}")
...
if __name__ == '__main__':
    ...
    if len(cks) == 1:
        ...
        activityUrl = f"https://lzdz1-isv.isvjcloud.com/m/1000007395/7722148/{activityId}/?shareUuid={shareUuid}&adsource=null"
    num = 0
    for cookie in cks[:]:
        num += 1
        if num == 1:
        ...
        if num == 1:
            ...
            shareUuid = actorUuid
            activityUrl = f"https://lzdz1-isv.isvjcloud.com/m/1000007395/8487146/{activityId}/?shareUuid={shareUuid}&adsource=null"
