...
一次性脚本
邀请一人10豆 上限20左右
https://lzdz-isv.isvjcloud.com/dingzhi/bd/common/activity?activityId=90322060106
cron "1 1 1 1 1 1" jd_opencard0531.js
*/

const $ = new Env('5.31~6.8 大牌汇聚 年中献礼')
...
!(async () => {
    ...
    $.activityId = '90322060106'

    let authorCodeList = [
        '4047cb84fe1d4326b0fde4926a4e0e43',
        '83722622db7147d3998be0936d84b810',
    ];
...
async function run() {
    try {
        ...
        await $.wait(1500);
        $.openList = [72392 ,160918 ,801136 ,74119 ,10144823 ,10226475 , 10538814 ,532400 ,107952 ,179146 ,677216 ,34830 ,11571818 ,12099820 ,10126038 ,12197733];
