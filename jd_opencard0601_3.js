/*
6.1~6.18 618大牌有礼 暖心陪伴 (https://lzdz-isv.isvjcloud.com/dingzhi/bd/common/activity/4988224?activityId=90322060102&shareUuid=019b4e2bdeb84d2d9f71b4ecba19f061&adsource=null&shareuserid4minipg=0JNwymG0n/7MOPkHzYrG4KuPlrbwajr+mlKSAUQGJeinh9LA4YCEcFb8KdjJBCTv&shopid=undefined)
...
const $ = new Env('6.1~6.18 618大牌有礼 暖心陪伴')
...
!(async () => {
    ...
    $.activityId = '90322060102'

    let authorCodeList = [
        '019b4e2bdeb84d2d9f71b4ecba19f061',
        'c426ab98f9b64002b93648cccbb2d0c0',
    ];
...
async function run() {
    try {
        ...
        await $.wait(1500);
        $.openList = [1000004123 ,1000004065 ,1000000866 ,1000376284 ,10086660 ,1000105175 ,11052940 ,1000099584 ,1000278417 ,1000370807 ,1000187767 ,1000009782 ,1000086085 ,1000410617];
