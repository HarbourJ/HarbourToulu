...
All变量适用
————————————————
入口：[ 6.8-6.18 全利以赴 谁是囤货王 (https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=dzlhkk081f1bc4bacd11ec99b60200&shareUuid=d68b110e2da34a4b970a43470f6fc27d)]
...
!(async () => {
  ...
  $.shareUuid = "00fb5fe272824460844830617a7ea29e"
  console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
  let shareUuidArr = [$.shareUuid,'00fb5fe272824460844830617a7ea29e','45560a7d188c4413add451befb5ebeb1']
