...
"""
File: jd_opencardH0922.py(9.22-10.3 金秋好礼 中秋相伴(金币))
Author: HarbourJ
Date: 2023/9/12 00:00
TG: https://t.me/HarbourToulu
cron: 0 0 */3 22-30,1-3 9,10 *
new Env('金秋好礼 中秋相伴');
ActivityEntry: https://lzdz1-isv.isvjcloud.com/dingzhi/joinCommon/activity/5929859?activityId=ac4631db1b4046c3852650c2f7c74720
并发变量：export jd_joinCommon_uuid="你的uuid"
并发命令：task HarbourJ_HarbourToulu_main/jd_opencardH0922.py conc JD_COOKIE 1-20
"""
